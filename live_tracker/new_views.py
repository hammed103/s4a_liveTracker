...
class start(APIView):
    ...
    def get(req):
        ...
        oki = jk[jk.Date.isin([str(date.today() - timedelta(5)),str(date.today() - timedelta(4)),str(date.today() - timedelta(3)),str(date.today() - timedelta(2)),str(date.today() - timedelta(1))])]
